...
Another way to contribute to NeuralNetworks is to file
...
Then go to [https://github.com/singularitti/NeuralNetworks.jl/pulls](https://github.com/singularitti/NeuralNetworks.jl/pulls)
